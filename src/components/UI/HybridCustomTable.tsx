...
const HybridCustomTable: FC<CustomTableProps> = (props) => {
  ...
  return (
    <Box>
      <Table
        {...getTableProps()}
        sx={{
          borderSpacing: "0 0.3rem", // Adjust the spacing between cells
          ...
          {page.map((row: any, index: any) => {
            ...
            return (
              <TableRow
                ...
                sx={{
                  backgroundColor: index & 1 ? "#F1F8F3" : "background.paper",
...
export default HybridCustomTable;
