...
const RouteLazyLoader = {
  ...
  BuyerAccounts: Loadable(lazy(() => import("../pages/Sourcing/BuyerAccounts"))),
  BuyerAccountDetails: Loadable(lazy(() => import("../pages/Sourcing/BuyerAccountDetails"))),
  ...
  TALsReport: Loadable(lazy(() => import("../pages/Sourcing/TALsReport"))),
  TonnageReport: Loadable(lazy(() => import("../pages/Sourcing/TonnageReport"))),
  ...
  PurchaseOrders: Loadable(lazy(() => import("../pages/Sourcing/PurchaseOrders"))),
  PurchaseOrderDetails: Loadable(lazy(() => import("../pages/Sourcing/PurchaseOrderDetails"))),
