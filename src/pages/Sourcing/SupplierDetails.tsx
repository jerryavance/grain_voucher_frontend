            ...
            <Card>
              <CardContent>
                ...
                {/* <Box sx={styles.infoRow}>
                  ...
                  <Span sx={styles.value}>{supplier.user.phone}</Span>
                </Box>
                <Box sx={styles.infoRow}>
                  <Span sx={styles.label}>Email:</Span>
                <Span sx={styles.value}>{supplier.user.username || "Not provided"}</Span>
                </Box> */}
                ...
                {supplier.is_verified && supplier.verified_by && (
                  <>
                    <Box sx={styles.infoRow}>
                      <Span sx={styles.label}>Verified By:</Span>
                      <Span sx={styles.value}>
                        {supplier.verified_by.first_name} {supplier.verified_by.last_name}
                      </Span>
                    </Box>
                    <Box sx={styles.infoRow}>
